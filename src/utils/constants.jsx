...
export const studentsArr = [
    {
        ...
        testimonial: `I've known Heinrich since our school days, and it was a pleasant surprise to find that he was conducting programming courses. Pravin's teaching methods are great, very clear and concise. He helped me understand the concepts easily and is one of the best lecturers I've had.`,
        image: mihirImg,
    },
    {
        name: 'Disha Mhatre',
    ...
    },
    {
        ...
        testimonial: `I'm so grateful for the guidance and support Heinrich provided in teaching me web development. His patience, expertise, and willingness to share knowledge have been invaluable to me. He's a great friend as well as a mentor. I look forward to continuing to learn and grow in this field, thanks to his inspiration and teachings.`,
        image: darshilImg,
    },
    {
        name: 'Mukesh Billa',
        ...
        instaLink: '#',
        linkedInLink: '#',
        testimonial: `I wholeheartedly recommend Heinrich Holland as a MERN Stack Developer and mentor. His expertise and guidance played a crucial role in my projects, and his willingness to encourage growth in others is praiseworthy. He is a valuable asset to any team.`,
        image: mukeshImg,
    },
    {
