...
const Footer = () => {
    ...
    const pravinPortfolioEmail = 'seniordev86@gmail.com';
    ...
    const handleEmailCopyClick = () => {
        ...
        setTimeout(() => {
            emailContentRef.current.textContent = 'seniordev86@gmail.com';
        }, 3000);
    };
    ...
    return (
		...
		C72.834,60.054,69.171,64.043,64.531,64.043z"
                            ...
                            <div className={styles.mail_btns_container}>
                                ...
                                >
                                    <span ref={emailContentRef}>seniordev86@gmail.com</span>
                    ...
                    <div className={styles.footer_column}>
                        <div className={styles.copyright_container}>
                            <p className="body_text_200">
                                &copy; {new Date().getFullYear()}, designed and built by Heinrich.
                            </p>
                        </div>
                    </div>
                </div>
